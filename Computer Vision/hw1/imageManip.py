...
def mix_images(image1, image2, channel1, channel2):
    ...
    # extracting left half from image 1 (beginning till middle)
    out[:, 0:int(image1.shape[1]/2)] = image1[:, 0:int(image1.shape[1]/2)]

    # extracting right half from image 2 (middle till end)
