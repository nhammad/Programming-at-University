...
if __name__ == '__main__':
    ...
    f1.cmd("bird -c ./f1-bird.conf -s /var/run/f1-bird.ctl")
    f2.cmd("bird -c ./f2-bird.conf -s /var/run/f2-bird.ctl")
    f3.cmd("bird -c ./f3-bird.conf -s /var/run/f3-bird.ctl")
    f4.cmd("bird -c ./f4-bird.conf -s /var/run/f4-bird.ctl")

    e1.cmd("bird -c ./e1-bird.conf -s /var/run/e1-bird.ctl")
    e2.cmd("bird -c ./e2-bird.conf -s /var/run/e2-bird.ctl")
    e3.cmd("bird -c ./e3-bird.conf -s /var/run/e3-bird.ctl")
    e4.cmd("bird -c ./e4-bird.conf -s /var/run/e4-bird.ctl")
    ...
    f1.cmd("birdc -s /var/run/f1-bird.ctl down")
    f2.cmd("birdc -s /var/run/f2-bird.ctl down")
    f3.cmd("birdc -s /var/run/f3-bird.ctl down")
    f4.cmd("birdc -s /var/run/f4-bird.ctl down")

    e1.cmd("birdc -s /var/run/e1-bird.ctl down")
    e2.cmd("birdc -s /var/run/e2-bird.ctl down")
    e3.cmd("birdc -s /var/run/e3-bird.ctl down")
    e4.cmd("birdc -s /var/run/e4-bird.ctl down")
